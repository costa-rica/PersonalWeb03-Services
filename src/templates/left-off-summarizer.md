...
The summary should be a concise summary of the day's progress. It should be no longer than 100 words. It will be in markdown format but cannot use double quotes. Please use bullets to make the summary more readable. The beginning should be a short summary of the progress made. Use the correct time framing for the summary. If most of the work is condnesed to one project that was most recent you can use present tense. If it is spread out over multiple projects you can use past tense.
